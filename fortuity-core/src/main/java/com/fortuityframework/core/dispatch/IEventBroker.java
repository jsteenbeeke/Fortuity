/*
 * Copyright 2010 Jeroen Steenbeeke
 *
...
/**
 * Basic interface for specifying event broker behavior. Mainly used for dependency injection, where injecting
 * an abstract class yields errors
 * 
